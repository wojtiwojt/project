...
class Article(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=False, related_name='article_author')
...
class Source(models.Model):
    ...
    title = models.CharField(max_length=255, blank=False) # get automaticaly in the future?
    article = models.ForeignKey(Article, on_delete=models.SET_NULL, null=True, blank=False)
    author = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=False, related_name='source_author')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
